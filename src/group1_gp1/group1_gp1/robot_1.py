...
class RobotOne(Node):
    """Class for robot_1's node which subscribes to /fleet/tasks."""

    def __init__(self) -> None:
        """Initializer function for the robot_1 subscriber node."""
    ...
    def _timer_callback(self) -> None:
        ...
        self.get_logger().info(f"Publishing status: {message.data} ({self._counter:.1f} s)")
